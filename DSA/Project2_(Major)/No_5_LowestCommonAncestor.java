...
public class No_5_LowestCommonAncestor {
	Node3 root;
	...
	private int findLCAInternal(Node3 root, int n1, int n2) {
	...
	private boolean findPath(Node3 root, int n, List<Integer> path) {
		// base case
		if (root == null) {
			return false;
		}
	...
	public static void main(String[] args) {
		No_5_LowestCommonAncestor tree = new No_5_LowestCommonAncestor();
